END. Using all the above as reference (don’t use any parts verbatim nor mention or reference this excerpt. Do not write in I, or you. More like The, This etc. so no first person etc. 
Please write a long article starting from the above and use all your own knowledge about the keywords/topic given above to.  make it long and full of important details but coherent and has flow and use the following tips:

Please write without using ANY em-dashes. Use headings and subheadings (markdown).
...
Remember I'd like an article that hits all the points above but us a lot of your own knowledge about the given topic but the style of writing should adhere to the following:
...
ELEMENTARY PRINCIPLES OF COMPOSITION
    ...
    Express co-coordinate ideas in similar form.
    ...
    A subject coming first in its sentence may be emphatic, but rarely by its position alone. In the sentence,
